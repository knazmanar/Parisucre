(function( $ ) {
	wp.customize.bind( 'ready', function() {
		...
		function cake_shop_bakery_customizer_label( id, title ) {
			...
			if ( id === 'cake_shop_bakery_preloader_hide' || id === 'cake_shop_bakery_sticky_header' || id === 'cake_shop_bakery_scroll_hide' || id === 'cake_shop_bakery_scroll_top_position' || id === 'cake_shop_bakery_products_per_row' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-cake_shop_bakery_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
		...
		cake_shop_bakery_customizer_label( 'cake_shop_bakery_scroll_top_position', 'Scroll to top Position' );
